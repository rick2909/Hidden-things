...
public class HiddenChestBakedModel implements IDynamicBakedModel {

    public static final ResourceLocation TEXTURE = new ResourceLocation(HiddenThingsMod.MODID, "block/hidden_chest");

    private TextureAtlasSprite sprite;

    public HiddenChestBakedModel (Function<Material, TextureAtlasSprite> spriteGetter){
        this.sprite = spriteGetter.apply(new Material(AtlasTexture.LOCATION_BLOCKS_TEXTURE, TEXTURE));
    ...
    public List<BakedQuad> getQuads(@Nullable BlockState state, @Nullable Direction side, @Nonnull Random rand, @Nonnull IModelData extraData) {
        ...
        BlockState mimic = extraData.getData(HiddenChestTile.MIMIC);
        //System.out.println("MIMICING: " + extraData);
        if (mimic != null && !(mimic.getBlock() instanceof HiddenChest)) {
